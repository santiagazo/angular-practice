...
<head>
  ...
  <link rel="stylesheet" href="{{ url('assets/css/blocks.css') }}">
  <link rel="stylesheet" href="{{ url('assets/css/one.style.css') }}">
	...
	<link rel="stylesheet" href="{{ url('assets/plugins/owl-carousel2/assets/owl.carousel.css') }}">
	...
	<link rel="stylesheet" href="{{ url('assets/plugins/revolution-slider/revolution/css/settings.css') }}">
	<!-- REVOLUTION LAYERS STYLES -->
	<link rel="stylesheet" href="{{ url('assets/plugins/revolution-slider/revolution/css/layers.css') }}">
	<!-- REVOLUTION NAVIGATION STYLES -->
	<link rel="stylesheet" href="{{ url('assets/plugins/revolution-slider/revolution/css/navigation.css') }}">

  <!-- CSS Theme -->
  <link rel="stylesheet" href="{{ url('assets/css/lawyer.style.css') }}">
...
<body id="body" data-spy="scroll" data-target=".one-page-header" class="demo-lightbox-gallery lawyer-style">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					<div class="menu-container">
						<ul class="nav navbar-nav">
							...
							<li class="page-scroll">
								<a href="#why-we"><span data-hover="Why we">Why we</span></a>
							</li>
							<li class="page-scroll">
								<a href="#benefits"><span data-hover="Benefits">Benefits</span></a>
							</li>
							<li class="page-scroll">
								<a href="#our-cases"><span data-hover="Our cases">Our cases</span></a>
							</li>
							<li class="page-scroll">
							...
							<li class="page-scroll">
								<a href="#blog"><span data-hover="Blog">Blog</span></a>
							</li>
							<li class="page-scroll">
					...
					<ul>
						...
						<li data-index="rs-68" data-transition="zoomout" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="assets/img-temp/promo/img1.jpg" data-rotate="0" data-saveperformance="off" data-title="Intro" data-description="">
							...
							<div class="tp-caption NotGeneric-Title tp-resizeme rs-parallaxlevel-0"
								...
								style="z-index: 7; white-space: nowrap; text-align: center; text-transform: uppercase;">The Law<br> Must Work
							</div>
			...
			<div class="container">
				...
				<div class="ms-staff-carousel">
					...
					<div class="master-slider" id="masterslider">
						<!-- Item 1 -->
						<div class="ms-slide">
							<img src="http://loremflickr.com/150/150/female" data-src="http://loremflickr.com/150/150/female" alt="">
							<div class="ms-info">
	...
	<script src="{{ url('assets/js/plugins/gmaps-ini.js') }}"></script>
	<script src="{{ url('assets/plugins/master-slider/masterslider/masterslider.min.js') }}"></script>

	<script src="{{ url('assets/plugins/revolution-slider/revolution/js/jquery.themepunch.tools.min.js') }}"></script>
	<script src="{{ url('assets/plugins/revolution-slider/revolution/js/jquery.themepunch.revolution.min.js') }}"></script>

	<!-- SLIDER REVOLUTION 5.0 EXTENSIONS (Load Extensions only on Local File Systems! The following part can be removed on Server for On Demand Loading) -->
	<script src="{{ url('assets/plugins/revolution-slider/revolution/js/extensions/revolution.extension.actions.min.js') }}"></script>
	<script src="{{ url('assets/plugins/revolution-slider/revolution/js/extensions/revolution.extension.carousel.min.js') }}"></script>
	<script src="{{ url('assets/plugins/revolution-slider/revolution/js/extensions/revolution.extension.kenburn.min.js') }}"></script>
	<script src="{{ url('assets/plugins/revolution-slider/revolution/js/extensions/revolution.extension.layeranimation.min.js') }}"></script>
	<script src="{{ url('assets/plugins/revolution-slider/revolution/js/extensions/revolution.extension.migration.min.js') }}"></script>
	<script src="{{ url('assets/plugins/revolution-slider/revolution/js/extensions/revolution.extension.navigation.min.js') }}"></script>
	<script src="{{ url('assets/plugins/revolution-slider/revolution/js/extensions/revolution.extension.parallax.min.js') }}"></script>
	<script src="{{ url('assets/plugins/revolution-slider/revolution/js/extensions/revolution.extension.slideanims.min.js') }}"></script>
	<script src="{{ url('assets/plugins/revolution-slider/revolution/js/extensions/revolution.extension.video.min.js') }}"></script>

	<!-- JS Page Level-->
	<script src="{{ url('assets/js/one.app.js') }}"></script>
	<script src="{{ url('assets/js/plugins/owl-carousel2.js') }}"></script>
	<script src="{{ url('assets/js/plugins/promo.js') }}"></script>
