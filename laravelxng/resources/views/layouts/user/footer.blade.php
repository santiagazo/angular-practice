				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-3 md-margin-bottom-40">
							<a href="index.html"><img id="logo-footer" class="footer-logo" src="{{ url('assets/images/logo2-default.png') }}" alt=""></a>
...
<script type="text/javascript" src="{{ url('assets/plugins/sweetalert-master/dist/sweetalert.min.js') }}"></script>
<script>
	$.ajaxSetup({
        headers: {
